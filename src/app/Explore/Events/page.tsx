...
export default function EventsPage() {
  const events = [
   { name: "Kandy Esala Perahera", image: "/assets/Images/UpgradePage/15.png" },
    { name: "Sinhala - Tamil New Year", image: "/assets/Images/UpgradePage/2.jpg" },
    ...
    { name: "Sri Lanka Tea Festival", image: "/assets/Images/UpgradePage/2.jpg" },
    { name: "Negombo - Arugam Bay Beach Festivals", image: "/assets/Images/UpgradePage/2.jpg" },
    { name: "Navarathri Festival", image: "/assets/Images/UpgradePage/2.jpg" },
    { name: "Galle Literary Festival", image: "/assets/Images/UpgradePage/2.jpg" },
    { name: "World Surf League Arugam Bay Pro", image: "/assets/Images/UpgradePage/2.jpg" },
  ];
